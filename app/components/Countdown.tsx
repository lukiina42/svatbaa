...
const EVENT_DATE = "September 6, 2025 11:00:00";
  ...
  return (
    <div className="w-full px-1 md:px-4">
      <div className="text-3xl font-head font-bold text-center mb-10 pt-10 text-gray-700 px-2">
        <h4 className="mb-1">Odpočítávání do naší svatby</h4>
      </div>

      <div className="flex justify-center pb-12">
        <NumberCard number={countdown.days} label="Dní" />
        <NumberCard number={countdown.hours} label="Hodin" />
        <NumberCard number={countdown.minutes} label="Minut" />
        <NumberCard number={countdown.seconds} label="Sekund" />
      </div>
    </div>
  );
});
